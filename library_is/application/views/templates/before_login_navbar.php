  <nav class="navbar fixed-top navbar-expand-md navbar-dark bg-dark justify-content-between">
    ...
    <form class="form-inline" method="post">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" data-toggle="modal" role="button" href="#modal_login">Login</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" data-toggle="modal" role="button" href="#modal_registration">Registration</a>
        </li>
      </ul>
  </nav>
